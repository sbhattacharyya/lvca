...
class SymbolVisitor extends SoarBaseVisitor<SymbolTree> {
    ...
    public Map<String, Map<String, AugmentedSymbolTree>> getAttributesAndValuesPerProduction() { return attributesAndValuesPerProduction; }

    public Map<String, Map<String, AugmentedSymbolTree>> getCheckAttributesAndValuesPerProduction() { return checkAttributesAndValuesPerProduction; }

    public Map<String, Map<String, AugmentedSymbolTree>> getUpdateAttributesAndValuesPerProduction() { return updateAttributesAndValuesPerProduction; }
    ...
    public SymbolTree visitSoar_production(SoarParser.Soar_productionContext ctx) {
        ...
        attributeVariableToArrayNamePerProduction.put(productionName, attributeVariableToArrayName);
        return null;
    }
